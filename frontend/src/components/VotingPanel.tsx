...
const VotingPanel = ({ options, timeRemaining, onVote }: VotingPanelProps) => {
      ...
      <div className="mb-6">
        <div className="flex justify-between items-center mb-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-mono text-neon-pink">{timeLeft}s remaining</span>
          </div>
        </div>
          ...
          >
            <div className="flex items-center gap-3">
              <div className={cn(
                ...
                selectedOption === option.id ? "border-neon-pink" : "border-muted-foreground"
              )}>
                {selectedOption === option.id && (

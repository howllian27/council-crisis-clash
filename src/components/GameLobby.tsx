      ...
      <div className="w-full max-w-4xl mx-auto p-6 glass-panel animate-fade-in">
            ...
            return (
              <div 
                ...
                className={cn(
                  ...
                  player ? "bg-secondary" : "bg-secondary bg-opacity-30 border-dashed"
                )}
              >
                {player?.id === currentSession.hostId && (
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-4">
            <Button variant="outline" onClick={leaveSession}>Leave Game</Button>
            {isHost && (
              <Button 
                glow={players.every(p => p?.isReady)}
                disabled={!players.every(p => !p || p.isReady)}
